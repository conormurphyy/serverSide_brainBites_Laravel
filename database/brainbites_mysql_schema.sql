...
INSERT INTO `posts` (`id`, `user_id`, `category_id`, `title`, `slug`, `summary`, `body`, `image_path`, `image_mime`, `image_base64`, `is_public`, `published_at`, `created_at`, `updated_at`) VALUES
  ...
  (5, 3, 5, 'How to study faster with active recall', 'how-to-study-faster-with-active-recall', 'Use retrieval practice and spaced repetition to improve retention.', 'Active recall means testing yourself instead of rereading notes. Pair it with spaced repetition by revisiting content over increasing intervals to move knowledge into long-term memory.', 'embedded', 'image/png', 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+/a6sAAAAASUVORK5CYII=', 1, NOW(), NOW(), NOW()),
  (6, 2, 1, 'JavaScript closures made easy', 'javascript-closures-made-easy', 'Understand closures with one practical coding pattern.', 'A closure happens when a function remembers variables from its outer scope even after that outer function finishes running. This is useful for private state and factory-style helpers.', 'embedded', 'image/png', 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+/a6sAAAAASUVORK5CYII=', 1, NOW(), NOW(), NOW());
